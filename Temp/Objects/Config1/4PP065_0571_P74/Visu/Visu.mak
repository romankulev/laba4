...
PANEL_HW_SOURCE_Visu=C:/Users/admin/Documents/KVBO-07-21/KULEV/prac4/Physical/Config1/Hardware.hw 
...
$(TEMP_PATH_Visu)/dis.PS2-Keyboard.vco: $(AS_PROJECT_PATH)/Physical/Config1/4PP065_0571_P74/VC/PS2-Keyboard.dis $(PANEL_HW_SOURCE_Visu)
	$(VCHWPP) -f '$(PANEL_HW_SOURCE_Visu)' -o '$(subst .vco,.vci,$(TEMP_PATH_Visu)/dis.PS2-Keyboard.vco)' -n Visu -d Visu -pal '$(PALFILE_Visu)' -c '$(AS_CONFIGURATION)' -p '$(AS_PLC)' -ptemp '$(AS_TEMP_PLC)' -B 'D4.52' -L '' -hw '$(CPUHWC)' -warninglevel 2 -so $(VC_STATIC_OPTIONS_Visu) -sos $(VC_STATIC_OPTIONS_Shared) -keyboard '$(AS_PROJECT_PATH)/Physical/Config1/4PP065_0571_P74/VC/PS2-Keyboard.dis' -fp '$(AS_VC_PATH)/Firmware/V4.52.0/SG4' -prj '$(AS_PROJECT_PATH)' -apj 'prac4' -sfas -vcob '$(VCOBJECT_Visu)'
...
BMINFO_SOURCES_Visu=$(AS_PROJECT_PATH)/Logical/Visu/Bitmaps/AlphaPadQVGA1.bminfo \
	...
	$(AS_PROJECT_PATH)/Logical/Visu/Bitmaps/unnamed.bminfo \
	$(AS_PROJECT_PATH)/Logical/Visu/Bitmaps/dfaf7a538ecc1610b9f92affe3f5db0e.bminfo \
	$(AS_PROJECT_PATH)/Logical/Visu/Bitmaps/Bitmap_3.bminfo \
	$(AS_PROJECT_PATH)/Logical/Visu/Bitmaps/Bitmap_4.bminfo 
...
TRD_SOURCES_Visu=$(AS_PROJECT_PATH)/Logical/Visu/Trends/TrendData_1.trd \
	...
	$(AS_PROJECT_PATH)/Logical/Visu/Trends/TrendData_8.trd 

TRE_SOURCES_Visu=$(AS_PROJECT_PATH)/Logical/Visu/Trends/Trend_7.tre \
...
$(TEMP_PATH_Visu)/tpr.NumPad.vco: $(AS_PROJECT_PATH)/Logical/Visu/TouchPads/NumPad.tpr
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu) -prj 'C:/Users/admin/Documents/KVBO-07-21/KULEV/prac4/Logical/Visu' -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4520 -sfas
...
$(TEMP_PATH_Visu)/bminfo.unnamed.vco: $(AS_PROJECT_PATH)/Logical/Visu/Bitmaps/unnamed.bminfo $(AS_PROJECT_PATH)/Logical/Visu/Bitmaps/unnamed.jpg
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4520 -sfas


$(TEMP_PATH_Visu)/bminfo.dfaf7a538ecc1610b9f92affe3f5db0e.vco: $(AS_PROJECT_PATH)/Logical/Visu/Bitmaps/dfaf7a538ecc1610b9f92affe3f5db0e.bminfo $(AS_PROJECT_PATH)/Logical/Visu/Bitmaps/dfaf7a538ecc1610b9f92affe3f5db0e.jpg
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4520 -sfas
...
$(TEMP_PATH_Visu)/bminfo.Bitmap_4.vco: $(AS_PROJECT_PATH)/Logical/Visu/Bitmaps/Bitmap_4.bminfo $(AS_PROJECT_PATH)/Logical/Visu/Bitmaps/Bitmap_4.jpg
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4520 -sfas
...
$(TEMP_PATH_Visu)/trd.TrendData_8.vco: $(AS_PROJECT_PATH)/Logical/Visu/Trends/TrendData_8.trd
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4520 -sfas
